...
#ifndef __FINANCE_PREF_ROW_CHECK_H__
#define __FINANCE_PREF_ROW_CHECK_H__

#include <gtk/gtk.h>

G_BEGIN_DECLS

#define FINANCE_TYPE_PREF_ROW_CHECK (finance_pref_row_check_get_type ())
