...
#ifndef __FINANCE_APPLICATION_H__
#define __FINANCE_APPLICATION_H__

#include <gtk/gtk.h>

G_BEGIN_DECLS

#define FINANCE_TYPE_APPLICATION (finance_application_get_type())
...
#endif /* __FINANCE_APPLICATION_H__ */
