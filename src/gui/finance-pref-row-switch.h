...
void          finance_pref_row_switch_add_settings  (FinancePrefRowSwitch *self,
                                                     GSettings            *settings);
...
const gchar * finance_pref_row_switch_get_key       (FinancePrefRowSwitch *self);

void          finance_pref_row_switch_set_key       (FinancePrefRowSwitch *self,
                                                     const gchar          *key);
